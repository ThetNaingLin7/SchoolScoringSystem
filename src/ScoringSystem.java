...
public class ScoringSystem {
    ...
    public static int validInputTeam(){
        ...
        while(!validInput) {
            try {
                ...
                System.out.println("Invalid Input. Please enter a number.(At least 4 teams)");
                scan.nextLine();
            }
        }
        return input;
    ...
    public static int validInputIndividual(){
        Scanner scan = new Scanner(System.in);
        ...
        while(!validInput) {
            try {
                ...
                System.out.println("Invalid Input. Please enter a number.(At least 2 to 20 individuals)");
                scan.nextLine();
            }
        }
        return input;
    ...
    public static void main(String[] args) {
        ...
        Scanner scan = new Scanner(System.in);
        // Setting up of the rules to the User / Client to provide appropriate inputs
        // for the code
        ...
        do {
            ...
            switch (option) {
                case 1:
                    ...
                    System.out.println("Enter the number of Teams Entering 5 EVENTS (At least 4 teams)");
                    int teamNo = validInputTeam();
                    ...
                    if (teamNo == 0) {
                        ...
                        System.out.println("Participate teams must be 4 or more!");
                    } else {
                        ...
                        ArrayList<Integer> winner_team_indices = new ArrayList<Integer>();

                        for (int i = 0; i < teamNo; i++) {
                            if (teamScore[i] > winner_team_score) {
                                winner_team_score = teamScore[i];
                                winner_team_indices.clear();
                            }

                            if (teamScore[i] == winner_team_score) {
                                winner_team_indices.add(i);
                            }

                            for (int x = 0; x < 5; x++) {
                                System.out.println("\t Team: " + teamName[i] + "\t " + "Participants: " + teamPart[y]
                                        + "\t Team Score: " + teamScore[i]);
                                y++;
                            }
                            System.out.println(
                                    "----------------------------------------------------------------------------\n");
                        ...
                        for (int i = 0; i < winner_team_indices.size(); i++) {
                            System.out.print(teamName[winner_team_indices.get(i)] + ", ");
                        }
                ...
                case 2:
                    ...
                    if (PartNo == 0) {
                        ...
                        for (int i = 0; i < 5; i++) {
                            System.out.println(
                                    "Enter Name of the event " + (i + 1) + " that the individuals are entering");
                            Pevent[i] = scan.next();
                        }
                        ...
                        for (int i = 0; i < PartNo; i++) {
                            ...
                            for (int a = 0; a < 5; a++) {
                                System.out.println("Enter rank of the individual: " + PartName[i] + " on the event"
                                        + (a + 1) + ": " + Pevent[a]);
                    ...
                    if (PartNo == 0) {
                        ...
                        System.out.println("Can't play the events with only one participant");
                    } else if (PartNo > 20) {
                        System.out.println("Only 20 Players can participate");
                    } else {
                        ...
                        System.out.print("Congratulation!! Players ");
                ...
                case 3:
                    ...
                    if (SpecTeamNo == 0) {
                        ...
                        for (int i = 0; i < SpecTeamNo; i++) {
                            ...
                            for (int a = 0; a < 1; a++) {
                                System.out.println(
                                        "Enter rank of the team: " + SpecTeamName[i] + " on the event: " + STevent[0]);
                    ...
                    if (SpecTeamNo == 0) {
                        ...
                        for (int i = 0; i < SpecTeamNo; i++) {
                            ...
                            for (int x = 0; x < 5; x++) {
                                System.out.println("\tTeam Name: " + SpecTeamName[i] + "\t Team Participants: "
                                        + SteamPart[y1] + "\t  Team Score: " + SpecTeamScore[i]);
                                y1++;
                            }
                            System.out.println("----------------------------------------------------------------------------");
                        }
                ...
                case 4:
                    ...
                    SpecPartNo = validInputIndividual();
                    ...
                    if (SpecPartNo == 0) {
                        ...
                        for (int i = 0; i < SpecPartNo; i++) {
                            ...
                            for (int a = 0; a < 1; a++) {
                                System.out.println("Enter rank of the individual " + SpecPartName[i] + " on the event:"
                                        + SPevent[0]);
                    ...
                    if (SpecPartNo == 0) {
                        ...
                        System.out.println("Can't play the event with only one participant.");
                    } else if (SpecPartNo > 20) {
                        System.out.println("Only 20 Players can participate");
                    } else {
